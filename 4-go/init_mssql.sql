...
IF OBJECT_ID('delivery_type', 'U') IS NOT NULL
BEGIN
    IF NOT EXISTS (SELECT * FROM delivery_type WHERE id = 1)
    BEGIN
        SET IDENTITY_INSERT delivery_type ON;
        INSERT INTO delivery_type (id, name) VALUES
            (1, 'Courier'),
            (2, 'Post');
        SET IDENTITY_INSERT delivery_type OFF;
    END
END
ELSE
BEGIN
    PRINT 'Error: Table delivery_type does not exist.';
END
GO

IF OBJECT_ID('payment_type', 'U') IS NOT NULL
BEGIN
    IF NOT EXISTS (SELECT * FROM payment_type WHERE id = 1)
    BEGIN
...
ELSE
BEGIN
    PRINT 'Error: Table payment_type does not exist.';
END
GO
...
ELSE
BEGIN
    PRINT 'Error: Table category does not exist.';
END
GO
...
ELSE
BEGIN
    PRINT 'Error: Table [user] does not exist.';
END
GO

IF OBJECT_ID('product', 'U') IS NOT NULL
BEGIN
    IF NOT EXISTS (SELECT * FROM product WHERE id = 1)
    BEGIN
...
ELSE
BEGIN
    PRINT 'Error: Table product does not exist.';
END
GO
...
ELSE
BEGIN
    PRINT 'Error: Table status does not exist.';
END
GO

IF OBJECT_ID('payment_method', 'U') IS NOT NULL
BEGIN
    IF NOT EXISTS (SELECT * FROM payment_method WHERE id = 1)
    BEGIN
...
ELSE
BEGIN
    PRINT 'Error: Table payment_method does not exist.';
END
GO
